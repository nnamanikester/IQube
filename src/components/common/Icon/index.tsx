...
export interface IconProps {
   ...
   * 'SimpleLineIcons'
   */
  type?: 'Ionicons' | 'AntDesign' | 'Entypo' | 'EvilIcons' | 'Feather' |
  'FontAwesome' | 'FontAwesome5' | 'Fontisto' | 'Foundation' |
  'MaterialIcons' | 'MaterialCommunityIcons' | 'Octicons' | 'Zocial' | 'SimpleLineIcons',
  /**
...
export const Icon: React.FC<IconProps> = ({ size=24, name, color, type="Ionicons", style }) => {
